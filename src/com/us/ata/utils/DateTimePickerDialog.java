        ...
        OnDateChangedListener, OnTimeChangedListener
{
    ...
    /**
     * @param dpReminder the dpReminder to set
     */
    ...
    /**
     * @param tpReminder the tpReminder to set
     */
    ...
    public Date getDate()
    {
        ...
        cal.setTime(DateTimePickerHelper.getDateFromDatePicket(dpReminder));
...
//                + ", "
//                + DateTimePickerHelper.getStringTimeFromTime(tpReminder.getCurrentHour(),
//                tpReminder.getCurrentMinute());
        String title = "Set Time Remind";
        setTitle(title);
    }
...
//                DateTimePickerHelper.NORMAL_DAY_OF_WEEK_FORMAT)
//                + ", "
//                + DateTimePickerHelper.getStringTimeFromTimePicker(tpReminder);
        String title = "Set Time Remind";
        setTitle(title);
    ...
    public void onTimeChanged(TimePicker view, int hourOfDay, int minute)
    {
        ...
        String title = DateTimePickerHelper.dateToString(
                DateTimePickerHelper.getDateFromDatePicket(dpReminder),
                DateTimePickerHelper.NORMAL_FORMAT)
                + ", "
                + DateTimePickerHelper.getStringTimeFromTime(hourOfDay, minute);
